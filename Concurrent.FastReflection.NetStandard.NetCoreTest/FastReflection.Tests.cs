...
namespace Concurrent.FastReflection.NetStandard.Test
{
	internal class InternalTestObject : TestObject { }
	...
	public class TestObject
	{
		...
		public int SomeBackedProperty { get => SomeField; set => SomeField = value; }
	...
	public class FastReflectionTests
	{
	    ...
	    public void ConstructClassParametricTest()
	    {
		    ...
		    Assert.DoesNotThrow(() => dlgt = type.DelegateForCtor<TestObject>(type.Module, typeof(int)));
